...
const CaseStudiesCollage = () => {
  return (
    <div className="absolute inset-0 grid place-items-center">
      ...
      >
        ...
        >
          <div className="flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-[0.14em] opacity-90">
            <Factory className="h-3 w-3" /> Pune · Automotive
          </div>
          <div>
            <div className="text-[10px] opacity-80">Case Study · 2025</div>
      ...
      {/* Front card — before/after impact */}
      <div
        ...
        >
          <div>
            ...
            <div className="mt-2 text-sm font-extrabold leading-snug max-w-[80%]">
              Chennai Auto Plant · Quality Turnaround
            </div>
          </div>
      ...
      {/* Floating badge — sustainability win */}
      <div
