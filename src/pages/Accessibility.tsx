...
const Accessibility = () => {
  ...
  const jsonLd = {
    ...
    description:
      "Accessibility Policy for the CII Smart Manufacturing Platform — our commitment to inclusive design and digital accessibility.",
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground terms-page">
      <SEO
        title="Accessibility Policy — CII Smart Manufacturing Platform"
        description="Our commitment to making the CII Smart Manufacturing Platform accessible to everyone — conformance, features, assistive technology support and how to report issues."
        type="article"
        jsonLd={jsonLd}
      />
      <ReadingProgressBar />
          ...
          <div ref={contentRef} className="max-w-3xl">
            ...
            >
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  We consider accessibility at every stage of design and development — not
                  as an afterthought.
                </li>
                <li>
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>EN 301 549</strong> — European standard for accessibility
                  requirements in ICT products and services.
                </li>
                <li>
                  <strong>GIGW 3.0</strong> — Guidelines for Indian Government Websites,
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>Focus indicators</strong> — Visible focus outlines help users
                  track their position on the page.
                </li>
                <li>
                  <strong>Screen-reader support</strong> — Semantic HTML, ARIA landmarks
                  and labels help assistive technologies interpret the interface.
                </li>
                <li>
                  <strong>Text resizing</strong> — Content remains readable and functional
                ...
                <li>
                  <strong>Alt text</strong> — Meaningful images have descriptive
                  alternatives; decorative images are marked appropriately.
                </li>
                <li>
                  <strong>Consistent navigation</strong> — Menus, breadcrumbs and page
            ...
            <AccessibilitySection
              ...
              summary="Encountered a barrier? Let us know — we take every report seriously and aim to respond within 5 business days."
            >
              <p>
            ...
            >
              ...
              <div className="mt-4 rounded-lg border border-[hsl(var(--navy-100))] bg-[hsl(var(--navy-050))] p-5">
                <p className="text-sm font-semibold text-[hsl(var(--navy-800))] mb-2">
                  CII Smart Manufacturing — Accessibility
                </p>
