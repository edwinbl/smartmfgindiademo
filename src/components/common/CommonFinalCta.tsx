...
const DEFAULT_CONTENT: CtaContent = {
  ...
  assistant: {
    ...
    description:
      "Get instant guidance on solution areas, outcomes and next steps — personalized to your context.",
  },
};
...
const ROUTE_CONTENT: { match: (path: string) => boolean; content: CtaContent }[] = [
  ...
  },
  {
    ...
    content: {
      ...
      assistant: {
        ...
        description:
          "Ask for case studies by sector, state or technology — and get tailored next steps for your plant.",
      },
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      assistant: {
        ...
        description:
          "Ask about summits, roundtables or webinars near you — and get tailored event recommendations.",
      },
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      description:
        "Partner with CII to accelerate Industry 4.0 adoption across Indian manufacturing — from MSMEs to large enterprises.",
      actions: [
        { label: "Take Readiness Assessment", to: "/readiness-assessment", icon: ClipboardCheck, variant: "primary" },
        { label: "Explore Programmes", to: "/programmes", icon: GraduationCap, variant: "secondary" },
      ...
      assistant: {
        ...
        description:
          "Learn about our platform, programmes and ecosystem — grounded in CII's published content.",
      },
    },
  },
  {
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                {content.actions.map((a) => {
                  ...
                  return (
                    <Link key={a.label} to={a.to ?? "/"} className={className} style={style}>
                      {inner}
                    </Link>
                  );
                })}
