...
const Welcome = () => {
  ...
  return (
    <>
      <SEO title="Welcome — Your Industry 4.0 Journey Starts Here" />
      <AuthLayout mobileTagline="Your Industry 4.0 Journey Starts Here">
        <AuthCard
          ...
          subtitle="We'll guide you through a personalized path — from a maturity assessment to curated solutions and a partner network ready to help you transform."
        >
          {/* Journey graphic */}
