...
- Move the section header ("All Programmes / Build the skills…") above the sidebar+grid row (matches Events placement).
...
### Out of scope
- `ProgrammeTypeTabs.tsx` file left in place (unused) — no functional impact; can be deleted later.
