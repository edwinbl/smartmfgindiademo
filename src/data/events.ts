...
export const events: EventItem[] = [
  ...
  // PAST
  {
    ...
    agenda: [
      ...
      { time: "Day 1 · 14:30", title: "Track sessions across 6 parallel halls", track: "Tracks" },
      { time: "Day 2 · 10:00", title: "AI on the Shop Floor — Live Demos", track: "Technology" },
      { time: "Day 2 · 15:00", title: "MSME Transformation Showcase", track: "MSME" },
      { time: "Day 3 · 11:00", title: "Sustainability & Net-Zero Manufacturing", speaker: "Asha Krishnan", track: "Sustainability" },
      { time: "Day 3 · 17:00", title: "Closing Plenary + Smart Manufacturing Awards", track: "Plenary" },
    ],
    report: {
      attendees: 3100,
      clustersCovered: ["Automotive", "Capital Goods", "Electronics", "Pharma", "Textiles", "Steel"],
      mainTakeaways: [
        "Indian manufacturers have moved from pilots to scale — over 40% of large enterprises now report enterprise-wide digital roadmaps.",
        "Data foundations and unified namespaces emerged as the top investment priority for the next 24 months.",
        "Workforce 4.0 is the binding constraint — reskilling programmes must triple capacity by 2027.",
        "MSMEs need shared infrastructure, financing instruments and cluster-led adoption support.",
        "Sustainability and Industry 4.0 are converging — energy data is the next high-ROI use case.",
      ],
      successStories: [
        "Tata Steel Kalinganagar — connected plant generating 2.1B data points/day driving predictive quality.",
        "Bosch Bidadi — AI-driven OEE programme delivering 11% throughput uplift across 9 lines.",
        "Mahindra Chakan — digital twin reducing changeover time by 38%.",
      ],
    },
    reportPdfUrl: "/__l5e/assets-v1/a38bc383-057c-4461-aae3-3874b0a3a028/workshop_report_industry40_2019.pdf",
    presentations: [
      { title: "State of Indian Manufacturing 2025 — Plenary", speaker: "Ravi Sankaran", url: "#", size: "4.6 MB" },
      { title: "Scaling AI on the Shop Floor", speaker: "Arjun Bhatia", url: "#", size: "5.2 MB" },
      { title: "MSME Transformation — Cluster Playbook", speaker: "Neha Kapoor", url: "#", size: "3.9 MB" },
    ...
    photographs: [
      ...
      { url: "https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=1200&q=80", caption: "CEO Forum — scaling beyond pilots" },
  ...
  },
  {
    ...
    organizers: [
      ...
      "CII Smart Manufacturing Council — Western Region",
    ],
    agenda: [
      { time: "Day 1 · 09:30", title: "Inaugural — MSMEs as the Backbone of Smart India", speaker: "Neha Kapoor", track: "Plenary" },
      { time: "Day 1 · 11:00", title: "Affordable Automation for MSMEs — Vendor Showcase", track: "Showcase" },
      { time: "Day 1 · 14:30", title: "Cluster Case Studies — Rajkot, Coimbatore, Pune", track: "Cluster" },
      { time: "Day 2 · 10:00", title: "Financing Digital Adoption — Banks & Schemes", track: "Finance" },
      { time: "Day 2 · 14:00", title: "Mentor Connect — 55 mentors, 200+ MSMEs", track: "Mentorship" },
      { time: "Day 2 · 16:30", title: "Closing — Cluster Pledges & Next Steps", track: "Plenary" },
    ],
    report: {
      attendees: 1400,
      ...
      successStories: [
        "Rajkot foundry cluster — IoT-based melt monitoring rolled out across 22 MSMEs.",
        "Coimbatore pumps cluster — predictive quality programme yielding 18% rework reduction.",
        "Pune auto-components — shared MES platform onboarding 35 Tier-2/3 suppliers.",
      ],
    },
    reportPdfUrl: "/__l5e/assets-v1/a38bc383-057c-4461-aae3-3874b0a3a028/workshop_report_industry40_2019.pdf",
    presentations: [
      { title: "MSMEs as the Backbone of Smart India — Inaugural", speaker: "Neha Kapoor", url: "#", size: "3.4 MB" },
      { title: "Affordable Automation Playbook for MSMEs", speaker: "Priya Narayanan", url: "#", size: "4.1 MB" },
      { title: "Financing Digital Adoption — Schemes & Instruments", url: "#", size: "2.7 MB" },
      { title: "Cluster Case Studies — Rajkot, Coimbatore, Pune", url: "#", size: "5.0 MB" },
    ],
    resourcePersons: [
    ...
    photographs: [
      ...
      { url: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1200&q=80", caption: "Vendor showcase — affordable automation" },
      { url: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1200&q=80", caption: "Mentor connect — one-on-one sessions" },
      { url: "https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&w=1200&q=80", caption: "Cluster pledges — closing ceremony" },
    ],
    learnings: [
      "MSME adoption rises sharply when peers in the same cluster share live, measurable results.",
      "Affordable plug-and-play kits (under ₹2 lakh) drive faster first-asset deployments.",
      "Mentor pools must be regional and language-localised to be effective.",
      "Scheme awareness is uneven — single-window digital access is needed at the cluster level.",
    ],
    accent: "orange",
  },
  {
