...
const DIRECTORIES: Directory[] = [
  {
    ...
    accent: "navy",
    short:
      "A curated compendium of India's Industry 4.0 ecosystem — technology providers, consultants, manufacturers and digital transformation enablers shaping the country's smart manufacturing journey.",
    long:
  ...
  },
  {
    ...
    accent: "teal",
    short:
      "An international companion edition profiling Singapore's Industry 4.0 ecosystem — smart manufacturing leaders, automation specialists and digital transformation enablers driving innovation across the region.",
    long:
...
const VALUE_PROPS = [
  {
    ...
    body: "Explore the organisations driving Industry 4.0 adoption across India and Singapore — from large manufacturers to specialised partners.",
  ...
  },
  {
    ...
    body: "Get an executive view of the technologies shaping the future of manufacturing — robotics, IIoT, AI, additive and beyond.",
      ...
      <div className="lg:col-span-7">
        <nav aria-label="Breadcrumb" className="mb-5 text-sm text-[hsl(var(--neutral-500))]">
          <ol className="flex items-center gap-1.5">
            <li>
              <Link to="/" className="hover:text-[hsl(var(--navy-700))]">
                Home
              </Link>
            </li>
            <li aria-hidden>
      ...
      >
        ...
        >
          ...
          <div className="text-[11px] font-bold uppercase tracking-[0.14em] text-white/80">
            {directory.region} · {directory.edition}
          </div>
...
const Directories = () => {
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    name: "Industry 4.0 Directories — CII Smart Manufacturing",
    description:
      "Curated Industry 4.0 ecosystem directories published by CII and its global partners — featuring technology providers, consultants, manufacturers and digital transformation enablers.",
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      <SEO
        title="Industry 4.0 Directories — Ecosystem Publications | CII Smart Manufacturing"
        description="Explore curated Industry 4.0 ecosystem directories from India and Singapore — discover technology providers, consultants, manufacturers and digital transformation enablers."
        jsonLd={jsonLd}
      />
      <WireHeader />
          ...
          <div className="container-cii">
            <div className="mb-10 max-w-2xl">
              ...
              <p className="mt-3 text-[15px] md:text-base text-[hsl(var(--neutral-700))] leading-relaxed">
                Each edition is a publication-grade compendium — designed for executives,
