...
export const ProgrammeOverview = ({ programme }: { programme: ProgrammeItem }) => (
  <div>
    ...
    <p className="mt-3 text-[hsl(var(--neutral-700))] leading-relaxed">
      Designed for India's manufacturing ecosystem, this {programme.type.toLowerCase()} combines expert-led instruction with practical, plant-grade application — so participants leave with capability they can deploy immediately.
    </p>
  </div>
);
