...
const DEFAULTS = {
  title: "CII Smart Manufacturing Platform — India's Industry 4.0 Gateway",
  description:
    "CII Smart Manufacturing helps Indian MSMEs assess, learn and adopt Industry 4.0 — readiness assessments, case studies, training and partner ecosystem.",
  keywords:
