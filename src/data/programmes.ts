...
export const programmes: ProgrammeItem[] = [
  // FLAGSHIP — Leadership
  {
    ...
    tags: ["Industry 4.0", "Japan–India", "CII", "JICA", "AOTS"],
    highlights: [
      { label: "Duration", value: "3 days" },
      { label: "Batches", value: "Gurgaon · Mumbai" },
      { label: "Partners", value: "CII · JICA · AOTS" },
    ...
    modules: [
      {
        label: "Day 1 · Morning",
        title: "Opening Ceremony & Lecture — Industry 4.0 in Japan / USA / Germany",
      ...
      },
      {
        ...
        title: "Whole group work — presentations & plenary",
      ...
      },
      {
        ...
        title: "Mumbai batch (4–6 July 2024) — same 3-day structure",
        duration: "3 days",
        topics: [
    ...
    gallery: [
      { type: "image", url: "/src/assets/programme-gallery-1.jpg", caption: "Opening ceremony — Gurgaon batch" },
      { type: "image", url: "/src/assets/programme-gallery-2.jpg", caption: "Group work with post-its and case studies" },
      { type: "image", url: "/src/assets/programme-gallery-3.jpg", caption: "Industry visit — Day 3" },
      { type: "image", url: "/src/assets/programme-gallery-4.jpg", caption: "Mumbai batch plenary presentations" },
    ],
    accent: "navy",
  },
