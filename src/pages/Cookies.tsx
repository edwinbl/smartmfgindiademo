...
const Cookies = () => {
  ...
  const jsonLd = {
    ...
    name: "Cookie Policy",
    description:
      "Cookie Policy for the CII Smart Manufacturing Platform — what cookies we use, why we use them and how you can manage your preferences.",
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground terms-page">
      <SEO
        title="Cookie Policy — CII Smart Manufacturing Platform"
        description="Learn how the CII Smart Manufacturing Platform uses cookies and similar technologies — what we track, why we do it, and how to control your preferences."
        type="article"
        jsonLd={jsonLd}
      />
      <ReadingProgressBar />
      ...
      <main>
        ...
        <div className="container-cii py-10 md:py-14 grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div ref={contentRef} className="max-w-3xl">
            ...
            >
              <p>
                The CII Smart Manufacturing Platform (the “Platform”) uses cookies and
            ...
            <CookiesSection
              ...
              number={3}
              title="Types We Use"
              summary="We use strictly necessary, functional, analytical and marketing cookies — each serving a different purpose."
            >
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Analytics providers</strong> — to help us understand traffic and
                  usage patterns.
                </li>
                <li>
                  <strong>Social media platforms</strong> — to enable sharing and social
                  features.
                </li>
                <li>
                  <strong>Embedded content providers</strong> — such as video or map
            ...
            >
              ...
              <div className="mt-4 rounded-lg border border-[hsl(var(--navy-100))] bg-[hsl(var(--navy-050))] p-5">
                <p className="text-sm font-semibold text-[hsl(var(--navy-800))] mb-2">
                  CII Smart Manufacturing — Privacy & Cookies
                </p>
