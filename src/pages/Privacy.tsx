...
const Privacy = () => {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground terms-page">
      <SEO
        title="Privacy Policy — CII Smart Manufacturing Platform"
        description="How the CII Smart Manufacturing Platform collects, uses, shares and safeguards your personal information — and the rights you have over your data."
        type="article"
        jsonLd={jsonLd}
      />
      <ReadingProgressBar />
      ...
      <main>
        ...
        <div className="container-cii py-10 md:py-14 grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-10 lg:gap-14">
          ...
          <div ref={contentRef} className="max-w-3xl">
            ...
            >
              <p>
                The Confederation of Indian Industry (“CII”, “we”, “us”) operates the
                CII Smart Manufacturing Platform (the “Platform”). We are committed to
            ...
            <PrivacySection
              ...
              summary="We collect the details you give us when you register, take an assessment or contact us — plus basic usage data to keep the Platform working well."
            >
              <p>We collect personal information in the following categories:</p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Account data</strong> — name, email, phone, organisation,
                  role and password.
                </li>
                <li>
                  <strong>Assessment inputs</strong> — operational, technological and
                  workforce details you provide while completing readiness
                  assessments.
                </li>
                <li>
                  <strong>Programme &amp; event data</strong> — registrations,
                  attendance and feedback for workshops, certifications and events.
                </li>
                <li>
                  <strong>Communications</strong> — messages you send us through forms,
            ...
            >
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  <strong>Programme partners</strong> — academic, government and
                ...
                <li>
                  <strong>Regulators &amp; authorities</strong> — when required by
            ...
            >
              <p>
                ...
                appropriate safeguards in place — such as contractual commitments —
            ...
            >
              <p>
                We may revise this Privacy Policy from time to time. The “Last Updated”
            ...
            >
              ...
              <div className="rounded-lg border border-border bg-[hsl(var(--neutral-50))] p-5">
                <p className="text-sm font-semibold text-[hsl(var(--navy-800))]">
                  Confederation of Indian Industry — Smart Manufacturing
                </p>
