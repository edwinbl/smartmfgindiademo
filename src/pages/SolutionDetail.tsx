            ...
            <div className="grid lg:grid-cols-12 gap-10 items-start">
              <div className="lg:col-span-8">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  ...
                  <Link to="/contact" className="btn-outline">Submit Enquiry</Link>
                  <Link to="/contact" className="btn-ghost">Talk to Expert</Link>
                </div>
              </div>
        ...
        <section className="py-16 lg:py-20 bg-background">
          <div className="container-cii">
            <div className="max-w-3xl mb-10">
              <div className="section-eyebrow mb-3">Problem → Solution → Benefit</div>
            ...
            >
              ...
              <div className="relative max-w-3xl">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  ...
                  <Link to="/contact" className="inline-flex items-center gap-2 h-12 px-6 rounded-md font-bold text-white border border-white/30 bg-white/10 hover:bg-white/15 backdrop-blur transition-colors">
