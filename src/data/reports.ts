...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    summary:
      "Examines how digital technologies, data analytics, and intelligent operations can improve efficiency, sustainability, and competitiveness within India’s chemical manufacturing sector.",
    type: "Industry Report",
    industry: "Chemicals",
    domain: "Smart Manufacturing",
  ...
  },
  {
    ...
    highlightStat: { value: "3×", label: "Faster recovery for cloud-native ops" },
  ...
  },
  {
    ...
    title: "Here’s How AI Can Help Keep Them Safe",
    summary:
  ...
  },
  {
    ...
    pages: 22,
    readingTime: "8 min",
    author: "CII × ODYSSEE CAE",
    publishedOn: "Feb 2024",
    gated: true,
    tags: ["AI/ML", "CAE", "NVH"],
    highlightStat: { value: "10×", label: "Faster NTF prediction" },
  },
  {
