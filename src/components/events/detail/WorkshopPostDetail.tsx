  ...
  return (
    <section className="py-10 md:py-12">
      <div className="container-cii space-y-8">
          ...
          <div className="mt-4 grid lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-4 grid gap-3">
              <div className="cii-card p-4">
                <div className="text-[10px] uppercase tracking-wide font-semibold text-[hsl(var(--neutral-500))]">Date · Duration</div>
                <div className="mt-1 font-display font-bold text-sm text-[hsl(var(--navy-900))]">{event.date}</div>
                <div className="text-xs text-[hsl(var(--neutral-700))]">{event.duration} · {event.location}</div>
        ...
        {/* 2. Key Insights & Takeaways — single dense block */}
        {r && (
          <div>
        ...
        {/* 9. Downloads & Related Resources — PDF + resource persons in one row */}
