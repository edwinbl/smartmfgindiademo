      ...
      <main>
        ...
        <section className="relative overflow-hidden text-white h-[calc(100svh-72px)] flex items-center" aria-label="Hero">
          ...
          <div className="container-cii relative py-10 grid lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-16 items-center">
            <div>
              <div className="eyebrow text-[hsl(var(--orange-100))] mb-4">Readiness Assessment</div>
              <h1 className="font-display font-bold text-[30px] sm:text-[36px] md:text-[44px] leading-[1.1] tracking-tight text-white">
                Understand Your{" "}
                <span className="bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(90deg, hsl(var(--orange-500)) 0%, hsl(var(--saffron)) 100%)" }}>Manufacturing Readiness</span>{" "}
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                {microTags.map((t) => (
                  <span key={t} className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold rounded-full border bg-white/10 border-white/20 text-white/90">
