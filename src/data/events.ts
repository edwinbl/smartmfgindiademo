...
export const events: EventItem[] = [
  ...
  // Note: Earlier fabricated entries (MSME Industry 4.0 Conclave 2025, Sustainable
  // Manufacturing Roundtable) were removed. Per user direction, only one fabricated
  // master-template example is retained per content type — `past-smart-mfg-summit-2025`
  // above demonstrates the full concluded-event layout for design reference.
  {
